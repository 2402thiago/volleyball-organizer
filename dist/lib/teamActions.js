...
export async function generateTeams() {
    try {
        ...
        const eligibleParticipants = participantsWithConsensus.filter(p => p.consensusLevel !== null && p.averageRanking !== null);
        ...
        levels.forEach(level => {
            const sortedByRanking = [...groupedByLevel[level]].sort((a, b) => { var _a, _b; return ((_a = a.averageRanking) !== null && _a !== void 0 ? _a : 0) - ((_b = b.averageRanking) !== null && _b !== void 0 ? _b : 0); });
        ...
        levels.forEach(level => {
            selectedByLevel[level].sort((a, b) => { var _a, _b; return ((_a = a.averageRanking) !== null && _a !== void 0 ? _a : 0) - ((_b = b.averageRanking) !== null && _b !== void 0 ? _b : 0); });
        });
        ...
        levels.forEach((level, levelIndex) => {
            ...
            teamOrder.forEach((teamNumber, playerIndex) => {
                ...
                team.players.push({
                    ...
                    positionInTeam: level // Type assertion since level matches the positionInTeam union
                });
            });
        });
        ...
        while (!hasValidGender && attempts < maxAttempts) {
            ...
            for (const team of teams) {
                ...
                if (!hasFemale) {
                    ...
                    const femaleInDonor = donorTeam.players.find(p => p.participant.gender === 'F' && p.positionInTeam === (maleInTeam === null || maleInTeam === void 0 ? void 0 : maleInTeam.positionInTeam));
